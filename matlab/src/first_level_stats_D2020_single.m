...
matlabbatch{1}.spm.stats.fmri_spec.sess(r).cond(c).duration = [ ...
	trials.T1_T3_Duration_fMRIsec(ind & trials.Run==1); ...
	trials.T1_T3_Duration_fMRIsec(ind & trials.Run==2); ...
	trials.T1_T3_Duration_fMRIsec(ind & trials.Run==3); ...
	trials.T1_T3_Duration_fMRIsec(ind & trials.Run==4) ...
	];
